...
export class App extends Component {
    ...
    getdata = (itemdata) => {
        ...
        axios.post("http://localhost:8090/todos", { text: itemdata, done: false, userid: reactLocalStorage.get("token") })
            .then((resp) => {
    ...
    oncheck = (id) => {
        ...
        for (var i of data) {
            if (i.id == id) {
                ...
                axios.post("http://localhost:8090/check", i)
                    .then(() => {
                        console.log("done");
    ...
    ondelete = (id) => {
        // console.log(id);
        this.tockencheck()
        axios.post("http://localhost:8090/del", { id: id })
            .then((resp) => {
                // console.log("deleted");
                axios.post("http://localhost:8090/all", { token: reactLocalStorage.get("token") })
                    .then((resp) => {
    ...
    onedit = (t) => {
        this.tockencheck()
        axios.put("http://localhost:8090/edit", { text: t, id: this.state.editId })
            .then(() => {
                console.log(t);
                this.setState({
                    editId: null
